...
public class App 
{
	...
	*/
    public static void main( String[] args )
    {
		...
		// Call bitwise OR operation
        Binary orResult = Binary.or(binary1, binary2);
        System.out.println("Bitwise Logical OR result is: " + orResult.getValue());

        // Call bitwise AND operation
        Binary andResult = Binary.and(binary1, binary2);
        System.out.println("Bitwise Logical AND result is: " + andResult.getValue());
